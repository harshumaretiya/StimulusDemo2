...
var map = {
	...
	"./geo_selector_controller.js": "./app/javascript/controllers/geo_selector_controller.js",
...
/***/ "./app/javascript/controllers/geo_selector_controller.js":
/*!***************************************************************!*\
  !*** ./app/javascript/controllers/geo_selector_controller.js ***!
  \***************************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_ApplicationControlle) {
  ...
  _createClass(_default, [{
    key: "beforeReflex",
    value: function beforeReflex(element, reflex) {
      _get(_getPrototypeOf(_default.prototype), "beforeReflex", this).call(this, element, reflex);

      if (reflex === 'GeoSelectorReflex#select_region') this.subregionPlaceholderTarget.hidden = false;
      if (reflex === 'GeoSelectorReflex#select_subregion') this.countryPlaceholderTarget.hidden = false;
      if (reflex === 'GeoSelectorReflex#select_country') this.detailPlaceholderTarget.hidden = false;
    }
  }]);
...
_default.targets = ['subregionPlaceholder', 'countryPlaceholder', 'detailPlaceholder'];
...
var DOMOperations = {
  ...
  // Storage .................................................................................................
  storageSetItem: function storageSetItem(config) {
    var key = config.key,
        value = config.value,
        type = config.type;
  ...
  storageRemoveItem: function storageRemoveItem(config) {
    var key = config.key,
        type = config.type;
...
/******/ });
//# sourceMappingURL=application-ef49175b76bd528087eb.js.map